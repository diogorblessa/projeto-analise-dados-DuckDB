...
| DI-012 | Q1 | valor_unit | inconsistencia_cruzada | H | 6 produtos com dois valor_unit cadastrados em razão exata 10x — vírgula decimal deslocada; 8 registros afetados (4 acima do limite IQR de R$1.304, 2 abaixo). Produto com preço inflado gera receita até 10x maior nas linhas afetadas | bloco 7c: `nunique por produto` → 6 produtos com `razao_max_min=10.0`; produtos: HD Externo 2TB (R$349/R$3490), Headset 7.1 (R$349/R$3490), Monitor 24" (R$899/R$8990), Mousepad XL (R$59,90/R$599), SSD 500GB (R$189/R$1890), Suporte Notebook (R$89,90/R$899) | pendente Q2 | open |
